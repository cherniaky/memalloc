...
static_assert(HEAP_CAP % sizeof(uintptr_t) == 0, "The heap capacity is not divisible by "
                                                 "the size of a pointer of this platform");
uintptr_t heap[HEAP_CAP / sizeof(uintptr_t)] = {0};
